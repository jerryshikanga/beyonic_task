"""
Django settings for beyonic_sign_up project.
...
SECRET_KEY = 'vfnku==el#+i5(nm@y1bz_j2bosgt!k^7o-7$*!gkw1d^1!c8a'
...
ROOT_URLCONF = 'beyonic_sign_up.urls'
...
WSGI_APPLICATION = 'beyonic_sign_up.wsgi.application'
